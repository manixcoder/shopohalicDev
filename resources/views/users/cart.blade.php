                  ...
                  <div class="cart-product">
                    ...
                    <div class="cart-contant">
                      ...
                      @if($product['delivery_type']=='Pickup')
                       ...
                       <select class="form-control" name="" id="" onchange="changeShippingAddress(this.value,{{$product['product_id']}});">
                        @foreach($UserDeliveryAddress as $address)
                        <option value="{{$address['delivery_address']}}">{{$address['delivery_address']}}</option>
                       @endforeach
                       </select>
                       @endif
...
<script>                                                                      
 ...
 function deleiveryAddress(product_id){
  var table="";
  table+="<table>";
  table+="<tr><input type='text' name='name' id='name' placeholder='Name' class='form-control' ></tr><br>";
  table+="<tr><input type='text' name='address' placeholder='Address' id='address' class='form-control' ></tr><br>";
  table+="<tr><input type='text' name='suburb' placeholder='Suburb' id='suburb' class='form-control' ></tr> <br>";
  table+="<tr><input type='text' name='city' placeholder='City' id='city' class='form-control' ></tr><br>";
  table+="<tr><input type='text' placeholder='State' name='state' id='state' class='form-control' ></tr><br>";
   table+="<tr><input type='number' placeholder='Zip Code' name='zip_code' id='zip_code' class='form-control' ></tr> <br>";
...
function submitForm(product_id){
  var address=$('#name').val()+', '+$('#address').val()+', '+$('#suburb').val()+', '+$('#city').val()+', '+$('#state').val()+', '+$('#zip_code').val();
