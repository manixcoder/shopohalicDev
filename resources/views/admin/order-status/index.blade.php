    ...
    <div class="container">
      <h3>Order Status
        <div class="form-group">
              <a href="{{ url('admin/orderstatus/create') }}" class="btn btn-primary bg-color  btn-section">Add New Order Status</a>
            </div>
      ...
      <thead>
        <tr>
          <th class="no-sort">Status Name</th>
      ...
      <tbody>
        ...
        <tr class="gradeX" id="row_{{$value->id}}">
          <td>{{$value->status_name}}</td>
         
          <td class="actions">
            &nbsp;&nbsp;&nbsp;
            <span>
              <a href="{{URL::to('admin/orderstatus/edit')}}/{{$value->id}}"> <i class="fa fa-pencil bg-orange" aria-hidden="true"></i> Edit
              </a>
            </span>
           <!--  <a  style="cursor:pointer;" onclick="deleteStatus({{$value->id}});"><i class="fa fa-trash bg-orange" aria-hidden="true"></i>
              Delete
            </a> -->
            &nbsp;&nbsp;&nbsp;
          </td>
