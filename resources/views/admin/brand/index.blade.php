    ...
    <div class="container">
      <h3>Brand </h3>
        <div class="form-group">
              <a href="{{ url('admin/brands/create') }}" class="btn btn-primary bg-color  btn-section">Add New Brand</a>
            </div>
      ...
      <tbody>
        ...
        <tr class="gradeX" id="row_{{$brand->id}}">
          ...
          <td class="actions">
            &nbsp;&nbsp;&nbsp;
            <span>
              <a href="{{URL::to('admin/brands/edit')}}/{{$brand->id}}"> <i class="fa fa-pencil bg-orange" aria-hidden="true"></i> Edit
              </a>
            </span>
           <!--  <a  style="cursor:pointer;" onclick="deleteStatus({{$brand->id}});"><i class="fa fa-trash bg-orange" aria-hidden="true"></i>
              Delete
            </a> -->
            &nbsp;&nbsp;&nbsp;
          </td>
