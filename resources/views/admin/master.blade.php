            ...
            <ul class="marchent-menu">
              ...
              <li class="marchent-dropmenu-sec">
                <a href="#" class="dropdown-headmenu">
                  ...
                  <img src="{{ asset('public/uploads/') }}/{{Auth::user()->profile_image}}" alt="icon" style="height: 37px; width: 34px; border-radius: 50%">
                  @else
          ...
          <div class="col-md-3 col-sm-3">
            <div class="payment-part">
              <a href="#" class="footer-logo">
                <img src="{{ asset('public/adminAssets/images/footer-logo.jpg') }}" alt="footer-logo"></a>
              <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
              <h6>WE ACCEPT</h6>
              <ul>
                <li>
                  <a href="#">
                    <img src="{{ asset('public/adminAssets/images/payment-img1.jpg')}}" alt="payment-img1">
                  </a>
                </li>
                <li>
                  <a href="#">
                    <img src="{{ asset('public/adminAssets/images/payment-img2.jpg')}}" alt="payment-img2">
                  </a>
                </li>
              </ul>
            </div>
