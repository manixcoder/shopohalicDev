...
<div class="right-marchent-wapper">
          <div class="product-detailform">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6">
                  <div class="form-group">
                    <input class="form-control" type="text" id="quantity" name="quantity" placeholder="Quantity (In Number)" required value="{{$productData->quantity}}">
                  </div>
                </div>
                <div class="col-md-12 col-sm-12">
                  <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6">
                  <div class="form-group">
                   ...
                   <option value="{{$size->id}}" {{is_array($sizeData) && in_array($size->id, $sizeData) ? 'selected' : '' }}>{{$size->size_name}}</option>
                    @endforeach   
                    </select>
                  </div>
                </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <select class="form-control" name="shipping" required>
                  ...
                  <option value="{{$shipping->id}}" @if($shipping->id==$productData->shipping) selected @endif>{{$shipping->location}}</option>
                  @endforeach
                </select>
              </div>
              <div class="col-md-6">
                <select class="form-control" name="expected" required>
                  ...
                  <option value="Expected Delivery Days 1" @if($productData->expected=='Expected Delivery Days 1') selected @endif>Expected Delivery Days 1</option>
                  <option value="Expected Delivery Days 2" @if($productData->expected=='Expected Delivery Days 2') selected @endif>Expected Delivery Days 2</option>
                </select>
              </div>
            </div>
          </div>
