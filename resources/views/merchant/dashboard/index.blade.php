...
<<div class="dashboard-marchent">
    <div class="container">
      <h3>Dashboard 
      <form method="GET" action="{{ url('/merchant/') }}" enctype="multipart/form-data">
            {{ csrf_field() }}
        <div class="pull-right range-inputbox">
          <div class="form-group">
            <input type="text"  class="form-control" id="start_date" name="start_date" placeholder="Start date" required value="{{$start_date}}">
          </div>
          <div class="form-group">
            <input type="text"  class="form-control" id="end_date" name="end_date" placeholder="End date" required value="{{$end_date}}">
          </div>
          <div class="form-group">
