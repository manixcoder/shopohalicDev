...
<div class="right-marchent-wapper">
          ...
          <div class="product-photosbox mt-10">
          ...
          <div class="pricinginc_box mt-10">

            <div class="panel panel-default">
              <div class="panel-heading"><h4>Pricing</h4></div>
              <div class="panel-body">
                  <p class="mb-0"><label>Normal Price</label></p>
                  <div class="pricinginc-input form-group input-group">
                    <span class="doller input-group-addon">$</span>
                    <input type="text"  class="form-control" id="price" name="price"  placeholder="Price" required value="{{$productData->price}}">
                  </div>

                  <p class="mb-0"><label>Special Price</label></p>
                  <div class="pricinginc-input form-group input-group">
                    <span class="doller input-group-addon">$</span>
                  ...
                  <div class="stock-lasts-box">
                    ...
                    <label class="radio-inline"><input type="radio" name="stock_type"  id="radio_1" @if($productData->stock_type=='till_stock_last') checked @endif value="till_stock_last" /> Till Stock Lasts</label>
                    
                    <label class="radio-inline"><input type="radio" name="stock_type" id="radio_2" @if($productData->stock_type=='date_range') checked @endif value="date_range"  /> Date Range</label>
                  </div>
              ...
              <div class="panel panel-default">
                  <div class="panel-heading"><h4>Pickup</h4></div>
                    <div class="panel-body"><div class="">
                      <label class="radio-inline"><input type="radio" name="pickup" @if($productData->pickup==0) checked @endif value="0" /> No</label>
                      <label class="radio-inline"><input type="radio" name="pickup" @if($productData->pickup==1) checked @endif value="1" /> Yes</label>
                    </div>
                  </div>
              </div>
          </div>
          ...
          <div class="shipping-box-date mt-10">
